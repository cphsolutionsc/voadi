    ...
    <>
      ...
      <div className="space-y-10 text-[#A89080]">
        ...
        <Section>
          ...
          <H3>Account data</H3>
          <UL>
            <LI><strong className="text-[#F5EDD0]">Full name</strong> — to identify your account and personalise your experience. Legal basis: performance of contract (Article 6(1)(b) GDPR).</LI>
            <LI><strong className="text-[#F5EDD0]">Email address</strong> — for account login, security notifications, and platform communications. Legal basis: performance of contract (Article 6(1)(b) GDPR).</LI>
            <LI><strong className="text-[#F5EDD0]">Password</strong> — stored as a one-way hash (bcrypt). We cannot read your password. Legal basis: performance of contract.</LI>
            <LI><strong className="text-[#F5EDD0]">County of residence</strong> — to surface relevant county-specific events and resources. Legal basis: performance of contract / consent.</LI>
          </UL>

          <H3>Optional profile data — special category</H3>
          <P>
            The following fields are entirely optional. They are treated as <strong className="text-[#F5EDD0]">special category data</strong> under Article 9 GDPR because, in the context of this platform, they may reveal or allow inference of racial or ethnic origin.
          </P>
          <UL>
            <LI><strong className="text-[#F5EDD0]">Nationality</strong> — to help us understand the diaspora groups using the platform and to tailor resources accordingly. Legal basis: your explicit consent (Article 9(2)(a) GDPR). You may withdraw consent at any time.</LI>
            <LI><strong className="text-[#F5EDD0]">Country of birth</strong> — same purpose and basis as nationality above.</LI>
          </UL>
          <P>
        ...
        <Section>
          ...
          <UL>
            <LI><strong className="text-[#F5EDD0]">Hosting infrastructure</strong> — your data is stored on servers provided by our hosting provider. Our hosting provider processes data as a data processor under a Data Processing Agreement and may not use your data for any independent purpose.</LI>
            <LI><strong className="text-[#F5EDD0]">Payment processing</strong> — if you make a voluntary contribution, payment details are processed by our payment provider (Stripe). VOADI does not receive or store full card details. Stripe's privacy policy applies to their processing.</LI>
            <LI><strong className="text-[#F5EDD0]">Legal obligations</strong> — we may disclose data if required by a valid court order, warrant, or instruction from a competent Irish authority. We will notify you of any such disclosure where legally permitted to do so.</LI>
          </UL>
          <P>
        ...
        <Section>
          ...
          <div className="overflow-hidden rounded-xl border border-[#2A1515]">
            {[
              ...
              <div key={type} className="flex flex-col gap-1 border-b border-[#2A1515] bg-[#1E0E0E] px-4 py-3 last:border-0 sm:flex-row sm:items-start sm:gap-4">
                <span className="w-52 shrink-0 text-xs font-semibold text-[#F5EDD0]">{type}</span>
                <span className="text-xs leading-relaxed text-[#8B7B6B]">{period}</span>
              </div>
            ))}
          </div>
        </Section>
        ...
        <Section>
          ...
          <UL>
            <LI><strong className="text-[#F5EDD0]">Right of access (Article 15)</strong> — to receive a copy of all personal data we hold about you.</LI>
            <LI><strong className="text-[#F5EDD0]">Right to rectification (Article 16)</strong> — to have inaccurate data corrected.</LI>
            <LI><strong className="text-[#F5EDD0]">Right to erasure (Article 17)</strong> — to have your data deleted where there is no legitimate reason to retain it.</LI>
            <LI><strong className="text-[#F5EDD0]">Right to restriction (Article 18)</strong> — to have processing restricted in certain circumstances.</LI>
            <LI><strong className="text-[#F5EDD0]">Right to data portability (Article 20)</strong> — to receive your data in a structured, commonly used, machine-readable format.</LI>
            <LI><strong className="text-[#F5EDD0]">Right to object (Article 21)</strong> — to object to processing based on legitimate interests.</LI>
